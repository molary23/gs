...
$footer_column = $shoppingcart_settings['shoppingcart_footer_column_section'];
	...
	if ( is_active_sidebar( 'shoppingcart_footer_options' ) ) :
		...
		echo '<div class="copyright">'; ?> Copy &copy;
		<a title="<?php echo esc_attr( get_bloginfo( 'name', 'display' ) ); ?>" target="_blank" href="<?php echo esc_url( home_url( '/' ) ); ?>"><?php echo get_bloginfo( 'name', 'display' ); ?></a> 2020 - <?php echo date('Y');/*| 
